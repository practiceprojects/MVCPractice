...
namespace PracticeMVC.Controllers
{
    ...
    {
        private PracticeMVCContext db = new PracticeMVCContext();
        ...
        public ActionResult Create([Bind(Include = "ClassID,Name,MyAge")] Class1 class1)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ClassID,Name,MyAge")] Class1 class1)
        {
            if (ModelState.IsValid)
            {
